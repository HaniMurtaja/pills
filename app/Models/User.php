...
//                $user->notify(new VerifyUserNotification($user));
    ...
    public function userUserHealths()
    {
        return $this->hasMany(UserHealth::class, 'user_id', 'id');
    }

    public function userReminderReminders()
    {
    ...
    {
        return $this->hasMany(Subscription::class, 'user_subs_id', 'id');
    }
    ...
    public function userOrdersOrders()
    {
