...
class CreateUserUserAlertPivotTable extends Migration
{
    public function up()
    {
        Schema::create('user_user_alert', function (Blueprint $table) {
            ...
            $table->foreign('user_alert_id', 'user_alert_id_fk_7934564')->references('id')->on('user_alerts')->onDelete('cascade');
            $table->unsignedBigInteger('user_id');
            $table->foreign('user_id', 'user_id_fk_7934564')->references('id')->on('users')->onDelete('cascade');
