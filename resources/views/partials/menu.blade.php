<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('user_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/permissions*") ? "c-show" : "" }} {{ request()->is("admin/roles*") ? "c-show" : "" }} {{ request()->is("admin/users*") ? "c-show" : "" }} {{ request()->is("admin/user-healths*") ? "c-show" : "" }} {{ request()->is("admin/user-medical-histories*") ? "c-show" : "" }} {{ request()->is("admin/user-docs*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('user_health_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.user-healths.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/user-healths") || request()->is("admin/user-healths/*") ? "c-active" : "" }}">
                    ...
                    @endcan
                    @can('user_medical_history_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.user-medical-histories.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/user-medical-histories") || request()->is("admin/user-medical-histories/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                    ...
                    @can('user_doc_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.user-docs.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/user-docs") || request()->is("admin/user-docs/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        @can('content_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/content-categories*") ? "c-show" : "" }} {{ request()->is("admin/content-tags*") ? "c-show" : "" }} {{ request()->is("admin/content-pages*") ? "c-show" : "" }} {{ request()->is("admin/medical-guides*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('medical_guide_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.medical-guides.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/medical-guides") || request()->is("admin/medical-guides/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.medicalGuide.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
        ...
        @endcan
        @can('user_order_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/services*") ? "c-show" : "" }} {{ request()->is("admin/orders*") ? "c-show" : "" }} {{ request()->is("admin/payment-methods*") ? "c-show" : "" }} {{ request()->is("admin/subscriptions*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.userOrder.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('service_access')
                        <li class="c-sidebar-nav-item">
