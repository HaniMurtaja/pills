...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-reminderUsers">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.user.fields.careby') }}
                        </th>
                        <th>
                            {{ trans('cruds.user.fields.reminder') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                @foreach($user->carebies as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-reminderUsers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
