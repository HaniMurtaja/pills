    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reminders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('applying') ? 'is-invalid' : '' }}" type="text" name="applying" id="applying" value="{{ old('applying', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('start_from') ? 'is-invalid' : '' }}" type="text" name="start_from" id="start_from" value="{{ old('start_from', '') }}" required>
