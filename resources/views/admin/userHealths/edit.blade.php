...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.userHealth.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-healths.update", [$userHealth->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="careby_id">{{ trans('cruds.userHealth.fields.careby_id') }}</label>
                <input class="form-control {{ $errors->has('careby_id') ? 'is-invalid' : '' }}" type="number" name="careby_id" id="careby_id" value="{{ old('careby_id', $userHealth->careby_id) }}" step="1" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $userHealth->name) }}" required>
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender" required>
                    ...
                    @foreach(App\Models\UserHealth::GENDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gender', $userHealth->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $userHealth->dob) }}" required>
                @if($errors->has('dob'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dob') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blood_pressure') ? 'is-invalid' : '' }}" type="text" name="blood_pressure" id="blood_pressure" value="{{ old('blood_pressure', $userHealth->blood_pressure) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blood_group') ? 'is-invalid' : '' }}" type="text" name="blood_group" id="blood_group" value="{{ old('blood_group', $userHealth->blood_group) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="number" name="height" id="height" value="{{ old('height', $userHealth->height) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="number" name="weight" id="weight" value="{{ old('weight', $userHealth->weight) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bmi') ? 'is-invalid' : '' }}" type="number" name="bmi" id="bmi" value="{{ old('bmi', $userHealth->bmi) }}" step="0.01" required>
                @if($errors->has('bmi'))
                    <div class="invalid-feedback">
                        {{ $errors->first('bmi') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_cholestrol') ? 'is-invalid' : '' }}" type="text" name="total_cholestrol" id="total_cholestrol" value="{{ old('total_cholestrol', $userHealth->total_cholestrol) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ldl_cholestrol') ? 'is-invalid' : '' }}" type="text" name="ldl_cholestrol" id="ldl_cholestrol" value="{{ old('ldl_cholestrol', $userHealth->ldl_cholestrol) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hdl_cholestrol') ? 'is-invalid' : '' }}" type="text" name="hdl_cholestrol" id="hdl_cholestrol" value="{{ old('hdl_cholestrol', $userHealth->hdl_cholestrol) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('triglycerides') ? 'is-invalid' : '' }}" type="text" name="triglycerides" id="triglycerides" value="{{ old('triglycerides', $userHealth->triglycerides) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('glucose') ? 'is-invalid' : '' }}" type="text" name="glucose" id="glucose" value="{{ old('glucose', $userHealth->glucose) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id">
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $userHealth->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
                    <div class="invalid-feedback">
