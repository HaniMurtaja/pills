...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.medicalGuide.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.medical-guides.update", [$medicalGuide->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="guide_name">{{ trans('cruds.medicalGuide.fields.guide_name') }}</label>
                <input class="form-control {{ $errors->has('guide_name') ? 'is-invalid' : '' }}" type="text" name="guide_name" id="guide_name" value="{{ old('guide_name', $medicalGuide->guide_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('guide_category') ? 'is-invalid' : '' }}" type="text" name="guide_category" id="guide_category" value="{{ old('guide_category', $medicalGuide->guide_category) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('guide_phone') ? 'is-invalid' : '' }}" type="text" name="guide_phone" id="guide_phone" value="{{ old('guide_phone', $medicalGuide->guide_phone) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('guide_working_hours') ? 'is-invalid' : '' }}" type="text" name="guide_working_hours" id="guide_working_hours" value="{{ old('guide_working_hours', $medicalGuide->guide_working_hours) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('guide_status') ? 'is-invalid' : '' }}" name="guide_status" id="guide_status" required>
                    ...
                    @foreach(App\Models\MedicalGuide::GUIDE_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('guide_status', $medicalGuide->guide_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('guide_address') ? 'is-invalid' : '' }}" type="text" name="guide_address" id="guide_address" value="{{ old('guide_address', $medicalGuide->guide_address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="text" name="latitude" id="latitude" value="{{ old('latitude', $medicalGuide->latitude) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="text" name="longitude" id="longitude" value="{{ old('longitude', $medicalGuide->longitude) }}">
