...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-userOrdersOrders">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($orders as $key => $order)
                        <tr data-entry-id="{{ $order->id }}">
                            ...
                            <td>
                                @foreach($order->user_orders as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-userOrdersOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
